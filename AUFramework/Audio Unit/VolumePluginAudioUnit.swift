...
public class VolumePluginAudioUnit: AUAudioUnit {

    private let parameters: VolumePluginParameters
    private let kernelAdapter: VolumePluginDSPKernelAdapter
    ...
    public override init(componentDescription: AudioComponentDescription,
        ...
        kernelAdapter = VolumePluginDSPKernelAdapter()

        // Create parameters object to control paramOne
        parameters = VolumePluginParameters(kernelAdapter: kernelAdapter)
